...
uiColorPage: function() {
    ...
    /**
     * This function tells the hardware to set the on timer
     * to whatever value is in the input box (in seconds
     **/
uiSetOnTimer: function() {
    ...
    /**
     * This function tells the hardware to set the off timer
     * to whatever value is in the input box (in seconds
     **/
